...
// indices. Once an element has been used it cannot be reused to pair 
// with another element. For instance, pairwise([1, 1, 2], 3) creates 
// a pair [2, 1] using the 1 at indice 0 rather than the 1 at indice 1,
//  because 0+2 < 1+2.
...
function pairwise(arr, arg) {
    ...
    return indexVals.reduce((a, b) => a + b);
  }
